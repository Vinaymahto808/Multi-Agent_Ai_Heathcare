...
export default function SummarizeSection() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-slate-800">Summarize Medical Text</h2>
        <p className="text-slate-500 mt-1">Paste medical text to get a concise AI-generated summary.</p>
      </div>
